...
class AutonomousPlanningAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        """
        self.log("Autonomous Planning Agent is initilizing")
    ...
    notify_function = {
        ...
        "parameters": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "description": "The description of the item itself scraped fromthe internet",
                },
                "deal_price": {
                    "type": "number",
    ...
    def plan(self, memory: List[str] = []) -> Optional[Opportunity]:
        ...
        :param memory: a list of URLs that hanve been surfaced in the past
